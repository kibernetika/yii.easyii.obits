...
-- Дамп данных таблицы yii_easy_obits.easyii_article_categories: 4 rows
...
-- Дамп данных таблицы yii_easy_obits.easyii_files: 1 rows
...
INSERT INTO `easyii_files` (`file_id`, `title`, `file`, `size`, `slug`, `downloads`, `time`, `order_num`) VALUES
	(1, 'Price list', '/uploads/files/example.csv', 104, 'price-list', 0, 1484748169, 1);
...
-- Дамп данных таблицы yii_easy_obits.easyii_pages: 11 rows
...
-- Дамп данных таблицы yii_easy_obits.easyii_seotext: 27 rows
...
-- Дамп данных таблицы yii_easy_obits.easyii_shopcart_goods: 0 rows
...
-- Дамп данных таблицы yii_easy_obits.easyii_shopcart_orders: 0 rows
